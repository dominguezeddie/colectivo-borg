...
**Versión:** v15 — Junio 2026 — Documento en evolución activa
...
- **Phi-4-mini** tiene licencia MIT (sin restricciones), corre en CPU con menos de 4GB de RAM y ofrece 128K de contexto. Es el modelo ideal para el hardware básico del Borg (PCs de 2016 con 4GB RAM).
- **Qwen3** tiene licencia Apache 2.0 (sin restricciones comerciales), es multilingüe (100+ idiomas) y supera a Llama 3 en tareas de código. Está disponible en varios tamaños (7B, 8B, 30B, 32B), lo que permite escalar según el hardware disponible.
